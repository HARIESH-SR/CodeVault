  ...
  monaco.languages.registerCompletionItemProvider(lang, {
    ...
    provideCompletionItems: async (model, position) => {
      try {
          ...
          if (keyword.startsWith(word)) {
            ...
            if (snippet) {
              suggestions.push({
                ...
                filterText: item.label, // support partial match like 'f' → 'forloop'
                range,
        ...
        // ✅ Also fetch default word suggestions from model itself
        const wordSuggestions = model.getValue().match(/\b\w+\b/g) || [];
        const uniqueWords = [...new Set(wordSuggestions)];
        ...
        return {
          suggestions: [...suggestions, ...wordBasedSuggestions]
        };
